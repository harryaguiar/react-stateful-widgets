...
export default function Counter() {
    /* STEP 1 */
  const number = 0;                         /*The 'count' state should be initialized to the number zero.*/
  let[count, setCount] = useState(number); /*Using the state hook, create a 'count', 'setCount' pair.*/
